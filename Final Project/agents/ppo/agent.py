...
class Policy:
    ...
    CREATOR_NAME = "Jinwoo Baik"  # Your preferred name here in a string
    CREATOR_UID = "705378164"  # Your UID here in a string

    def __init__(self):
        config = PPOConfig()
        self.agent = PPOTrainer(config=config)
        self.agent.load_w(log_dir=FOLDER_ROOT, suffix="iter25")
